/**
 * The follow player class file.
 *
 * @filename  FollowPlayer.cs
...
public class FollowPlayer : MonoBehaviour
{
	...
	void Awake()
	{
		...
		if (!CreateClassInstance("LgFollowPlayer") || !m_bReady)
		{
			return;
		}
	...
	private bool CreateClassInstance(string strClassName)
	{
		...
		m_cBehavior.SetData("m_vOffset", m_offset);
